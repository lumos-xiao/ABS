...
Slightly perturbed text (green) can mislead ChatGPT into judging the label of overall input from ``NEGATIVE'' (with a confidence of 91%) to ``POSITIVE'' (with a confidence of 96%).
